...
public final class MyServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.tmda.chatapp.helloworld.MyService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.tmda.chatapp.helloworld.HelloRequest,
      com.tmda.chatapp.helloworld.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.tmda.chatapp.helloworld.HelloRequest.class,
      responseType = com.tmda.chatapp.helloworld.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.tmda.chatapp.helloworld.HelloRequest,
      com.tmda.chatapp.helloworld.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.tmda.chatapp.helloworld.HelloRequest, com.tmda.chatapp.helloworld.HelloReply> getSayHelloMethod;
      ...
      synchronized (MyServiceGrpc.class) {
        if ((getSayHelloMethod = MyServiceGrpc.getSayHelloMethod) == null) {
          MyServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.tmda.chatapp.helloworld.HelloRequest, com.tmda.chatapp.helloworld.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tmda.chatapp.helloworld.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tmda.chatapp.helloworld.HelloReply.getDefaultInstance()))
  ...
  public static abstract class MyServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(com.tmda.chatapp.helloworld.HelloRequest request,
        io.grpc.stub.StreamObserver<com.tmda.chatapp.helloworld.HelloReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.tmda.chatapp.helloworld.HelloRequest,
                com.tmda.chatapp.helloworld.HelloReply>(
  ...
  public static final class MyServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MyServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.tmda.chatapp.helloworld.HelloReply sayHello(com.tmda.chatapp.helloworld.HelloRequest request) {
  ...
  public static final class MyServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MyServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.tmda.chatapp.helloworld.HelloReply> sayHello(
        com.tmda.chatapp.helloworld.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.tmda.chatapp.helloworld.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.tmda.chatapp.helloworld.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class MyServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.tmda.chatapp.helloworld.Helloworld.getDescriptor();
    }
